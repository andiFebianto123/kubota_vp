<?php if(isset($saveAction['active']) && !is_null($saveAction['active']['value'])): ?>
    <div id="saveActions" class="form-group">
        ...
        <button  class="btn btn-default" type="button" onclick="window.history.back()"><span class="la la-ban"></span> &nbsp;<?php echo e(trans('backpack::crud.cancel')); ?></a>
        <?php endif; ?>

    </div>
<?php endif; ?>

<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kubota_vp/kubota-vendor-portal/resources/views/vendor/backpack/crud/inc/form_save_buttons.blade.php ENDPATH**/ ?>