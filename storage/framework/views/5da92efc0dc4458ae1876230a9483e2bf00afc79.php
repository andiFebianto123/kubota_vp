...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div class="col-lg-8">
            <form class="form" action="<?php echo e(route('rectmedia.account.info.update')); ?>" method="post">
                    ...
                    <div class="card-body backpack-profile-form bold-labels">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input required class="form-control" type="<?php echo e(backpack_authentication_column()=='email'?'email':'text'); ?>" name="<?php echo e($field); ?>" value="<?php echo e(old($field) ? old($field) : $user->$field); ?>" disabled>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kubota_vp/kubota-vendor-portal/resources/views/vendor/backpack/base/my_account.blade.php ENDPATH**/ ?>