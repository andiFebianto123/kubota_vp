                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="filter_forecast_by" id="">
                            <?php $__currentLoopData = $arr_filter_forecasts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if(isset($crud->type)): ?>
                                <?php if($aff == $crud->type): ?>
                                  <option value="<?php echo e($aff); ?>" selected><?php echo e(strtoupper($aff)); ?></option>
                                <?php else: ?>
                                  <option value="<?php echo e($aff); ?>" ><?php echo e(strtoupper($aff)); ?></option>
                                <?php endif; ?>
                              <?php endif; ?>
    ...
    <div class="<?php echo e($crud->getListContentClass()); ?>">
        ...
        <table id="crudTable" class="bg-white table table-striped table-hover nowrap rounded shadow-xs border-xs mt-2" style="border-collapse: collapse;" cellspacing="0">
            <thead>
              ...
              <?php endif; ?>
              <?php if($crud->type == 'days'): ?>
                <tr>
                  <th style="background-color: #F5F5F5!important; position: -webkit-sticky; position: sticky; left: 0px;"></th>
                <?php
                  $z_index = 100;
                ?>
                <?php $__currentLoopData = $crud->columnHeader->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php
                    $key = $header['key'].'-01';
                  ...
                  ?>
                  <th colspan="<?php echo e($colspan); ?>" class="" style="border:1px solid #DADADA; z-index: <?php echo e($z_index); ?>; text-align: center;">
                      <?php echo $key; ?>
              ...
              <tr>
                ...
                <?php $__currentLoopData = $crud->columns(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($column['label']): ?>
                    ...
                    ?>
                    <th
                      class="<?php echo e($classHeaderNameItem); ?>"
            ...
            <tfoot>
              <tr>
                ...
                <?php $__currentLoopData = $crud->columns(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  ?>
                  <?php if($column['label'] == 'Nama Item'): ?>
                    <th style="background-color: #F5F5F5!important; position: -webkit-sticky; position: sticky; left: 0px;"><?php echo $column['label']; ?></th>
                  <?php else: ?>
...
<?php echo $__env->make(backpack_view('blank'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kubota_vp/kubota-vendor-portal/resources/views/vendor/backpack/crud/list-forecast.blade.php ENDPATH**/ ?>