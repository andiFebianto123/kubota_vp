...
<?php if($crud->hasAccess('create')): ?>
	...
	<?php endif; ?>
<?php endif; ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kubota_vp/kubota-vendor-portal/resources/views/vendor/backpack/crud/buttons/create.blade.php ENDPATH**/ ?>