		...
		<div class="form-group backpack-filter mb-0">
			<div class="input-group date">
		        ...
		        <input class="form-control pull-right"
		        		id="daterangepicker2-<?php echo e($filter->key); ?>"
		        		type="text"
...
<?php $__env->startPush('crud_list_scripts'); ?>
  <script>
  		...
  		function applyDateRangeFilter2<?php echo e($filter->key); ?>(start, end) {
		...
		jQuery(document).ready(function($) {
			...
			var dateRangeInput = $('#daterangepicker2-<?php echo e($filter->key); ?>');
            ...
            dateRangeInput.on('apply.daterangepicker', function(ev, picker) {
				applyDateRangeFilter2<?php echo e($filter->key); ?>(picker.startDate, picker.endDate);
			});
			...
			$(".daterangepicker-<?php echo e($filter->key); ?>-clear-button").click(function(e) {
				e.preventDefault();
				applyDateRangeFilter2<?php echo e($filter->key); ?>(null, null);
			});
		});
  </script>
<?php $__env->stopPush(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kubota_vp/kubota-vendor-portal/resources/views/vendor/backpack/crud/filters/date_range_custom.blade.php ENDPATH**/ ?>