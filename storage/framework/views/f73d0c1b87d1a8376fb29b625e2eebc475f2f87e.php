...
<body>
    <div>
        <?php $__currentLoopData = $deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
        <div <?php if($key % 2 != 0): ?> class="page_break" <?php endif; ?> style="margin-bottom: 40px;"> 
                        ...
                        <tr>
                            ...
                            <td width="25%">
                                ...
                                <?php if($constant::getRole() == 'Admin PTKI'): ?>
                                    <?php if($with_price == 'yes'): ?>
                                        <strong class="right"><?php echo e($delivery_show->currency." " . number_format($delivery_show->unit_price,0,',','.')); ?></strong>
                                    <?php else: ?>
                                        <strong> - </strong>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <?php if($constant::checkPermission('Print DS with Price') || $with_price == 'yes'): ?>
                                        <strong class="right"><?php echo e($delivery_show->currency." " . number_format($delivery_show->unit_price,0,',','.')); ?></strong>
                                    <?php elseif($constant::checkPermission('Print DS without Price') || $with_price == 'no'): ?>
                                        <strong> - </strong>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </td>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kubota_vp/kubota-vendor-portal/resources/views/exports/pdf/delivery-sheet-multiple.blade.php ENDPATH**/ ?>