...
<?php echo $__env->make('crud::fields.inc.wrapper_start', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <input type="hidden" class="form-control" name="<?php echo e($field['name']); ?>" value="<?php echo e($field['value']); ?>">
    ...
    <div class="input-group date">
        <input
            data-bs-datepicker="<?php echo e(isset($field['date_picker_options']) ? json_encode($field['date_picker_options']) : '{}'); ?>"
...
<?php if($crud->fieldTypeNotLoaded($field)): ?>
    ...
    <script src="<?php echo e(asset('packages/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')); ?>"></script>
    <?php if($field_language !== 'en'): ?>
        <script charset="UTF-8" src="<?php echo e(asset('packages/bootstrap-datepicker/dist/locales/bootstrap-datepicker.'.$field_language.'.min.js')); ?>"></script>
    <?php endif; ?>
    <script>
        if (jQuery.ui) {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kubota_vp/kubota-vendor-portal/resources/views/vendor/backpack/crud/fields/date_picker.blade.php ENDPATH**/ ?>