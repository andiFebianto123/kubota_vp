...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('delivery') }}"><i class="nav-icon la la-file"></i> Delivery Sheet</a></li>
<li class='nav-item'><a class='nav-link' href="{{ backpack_url('purchase-order') }}"><i class='nav-icon la la-newspaper'></i> Purchase orders</a></li>
