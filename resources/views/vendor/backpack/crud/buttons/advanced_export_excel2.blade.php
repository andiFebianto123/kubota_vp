@if ($crud->hasAccess('advanced_export_excel'))
    <button id="btn-for-form-adv-export-excel2" class="btn btn-sm btn-primary-vp" data-route="{{$crud->exportRoute2}}" type="button" onclick="exportExcel(this)" ><i class="la la-file-excel"></i> Export</button>
@endif
